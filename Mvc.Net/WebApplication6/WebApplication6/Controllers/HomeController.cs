...
namespace WebApplication6.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string FullName, string Age, string Email)
        {
            ...
            {
                ModelState.AddModelError("FullName", "FullName is Requied !!");
                ViewData["FullNameError"] = "*";
            }
            if (Age.Equals("") == true)
            {
                ModelState.AddModelError("Age", "Age is Requied !!");
                ViewData["AgeError"] = "*";
            }
            if (Email.Equals("") == true)
            {
                ModelState.AddModelError("Email", "Email is Requied !!");
                ViewData["EmailError"] = "*";
            }
            else
            {
            ...
            {
                ViewData["SuccessMsg"] = "<script>alert('Data has been Submitted !!')</script>";
                ModelState.Clear();
            }
            return View();
        }
